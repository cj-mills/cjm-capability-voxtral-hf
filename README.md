...
``` bash
pip install cjm_capability_voxtral_hf
```

## Project Structure

    nbs/
    └── capability.ipynb # Capability implementation for Mistral Voxtral transcription through Hugging Face Transformers
...
``` mermaid
graph LR
    capability["capability<br/>Voxtral HF Capability"]
```
...
### Voxtral HF Capability (`capability.ipynb`)

> Capability implementation for Mistral Voxtral transcription through
> Hugging Face Transformers

#### Import

``` python
from cjm_capability_voxtral_hf.capability import (
