...
Docs: https://cj-mills.github.io/cjm-capability-voxtral-hfcapability.html.md"""

# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/capability.ipynb.

# %% auto #0
__all__ = ['VoxtralHFCapabilityConfig', 'VoxtralHFCapability']

# %% ../nbs/capability.ipynb #f2fbcf2b
import logging
